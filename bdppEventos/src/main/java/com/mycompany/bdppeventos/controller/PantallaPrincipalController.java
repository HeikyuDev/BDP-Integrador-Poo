...
public class PantallaPrincipalController implements Initializable {
    ...
    // --- Botones de ventana ---
    @FXML
    private Button btnMinimizar; // si o si se tiene que llamar igual que el elemento Button cuya fx:id es
                                 // btnMinimizar De lo contrario Excepcion
    @FXML
    private Button btnMaximizar; // si o si se tiene que llamar igual que el elemento Button cuya fx:id es
                                 // btnMaximizar De lo contrario Excepcion
    @FXML
    private Button btnCerrar; // si o si se tiene que llamar igual que el elemento Button cuya fx:id es
                              // btnCerrar De lo contrario Excepcion
